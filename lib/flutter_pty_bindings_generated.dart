...
class FlutterPtyBindings {
  ...
  late final _pty_writePtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Pointer<PtyHandle>, ffi.Pointer<ffi.Int8>,
              ffi.Int32)>>('pty_write');
...
typedef Dart_NewNativePort_Type = ffi.Pointer<
    ffi.NativeFunction<
        Dart_Port_DL Function(
            ffi.Pointer<ffi.Int8>, Dart_NativeMessageHandler_DL, ffi.Uint8)>>;
...
typedef Dart_GetError_Type = ffi
    .Pointer<ffi.NativeFunction<ffi.Pointer<ffi.Int8> Function(ffi.Handle)>>;
...
typedef Dart_NewApiError_Type = ffi
    .Pointer<ffi.NativeFunction<ffi.Handle Function(ffi.Pointer<ffi.Int8>)>>;
...
class PtyOptions extends ffi.Struct {
  @ffi.Int32()
  external int rows;
  ...
  external ffi.Pointer<ffi.Int8> executable;

  external ffi.Pointer<ffi.Pointer<ffi.Int8>> arguments;

  external ffi.Pointer<ffi.Pointer<ffi.Int8>> environment;

  external ffi.Pointer<ffi.Int8> working_directory;
